...
const getGoods = async () => {
  const res = await getDetail(useRoute().params.id);
...
<template>
  <div class="xtx-goods-page">
    <!-- v-if="goods.details单词写错了 导致整个页面不显示 -->
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- <XtxSku :goods="goods" /> -->
              <!-- 使用组件并且传递参数 -->
              <StxSku :goods="goods" @change="skuChange(sku)"/>
              <!-- 数据组件 -->
          ...
          <div class="goods-footer">
            ...
            <div class="goods-aside">
              <!-- 24小时 -->
              <!-- 这里如果不加冒号的话，传给子组件的是字符串的1，加了冒号才可以识别类型为Number类型的1 -->
